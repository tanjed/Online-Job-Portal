       ...
       <div class="row" style="min-height: 800px">
           <div class="col-md-12 d-flex justify-content-center align-items-center" >
               <div class="jumbotron" style="width: 50%;">
                   ...
                   <form action="{{URL::to(route('company.register.process'))}}"  method="POST" style="margin-top: 50px;">
                       {{csrf_field()}}
                       <div class="row">
                           <div class="col-md-6">
                      ...
                      <center><button type="submit" class="btn btn-primary" style="width: 50%;">Submit</button></center>
                       <center><small style="padding: 15px;">Already have an account? <a href="{{route('company.login.show')}}">Login</a></small></center>
                       @if(!empty($errors))
